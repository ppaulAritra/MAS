...
@Entity(name="MLFM_ORDER_OWNER_TYPE")
public class ModelOrderOwnerType {
	
	@Id @GenericGenerator(name = "custom_sequence", strategy = 
			"com.biziitech.mlfm.IdGenerator")
	@GeneratedValue(generator = "custom_sequence")
	@Column(name="ORDER_OWNER_TYPE_ID")
	private Long orderOwnerTypeId;
	
	@Column(name="ORDER_OWNER_TYPE_NAME")
	private String orderOwnerTypeName;
	...
	public String getOrderOwnerTypeName() {
		return orderOwnerTypeName;
	}

	public void setOrderOwnerTypeName(String orderOwnerTypeName) {
		this.orderOwnerTypeName = orderOwnerTypeName;
	}
	...
	public String toString() {
		return "ModelOrderOwnerType [orderOwnerTypeId=" + orderOwnerTypeId + ", orderOwnerTypeName="
				+ orderOwnerTypeName + ", shortCode=" + shortCode + ", remarks=" + remarks + ", activeStatus="
