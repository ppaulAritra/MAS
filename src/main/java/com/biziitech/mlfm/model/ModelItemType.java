...
public class ModelItemType {
	...
	public long getParentItemTypeId() {
		return parentItemTypeId;
	}

	public void setParentItemTypeId(long parentItemTypeId) {
	...
	public String toString() {
		return "ModelItemType [itemTypeId=" + itemTypeId + ", itemTypeName=" + itemTypeName + ", levelNo=" + levelNo
				+ ", parentItemTypeId=" + parentItemTypeId + ", remarks=" + remarks + ", activeStatus=" + activeStatus
