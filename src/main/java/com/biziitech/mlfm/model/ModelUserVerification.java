...
@Entity(name="MLFM_USER_VERIFICATION")
public class ModelUserVerification {
	...
	public String toString() {
		return "ModelUserVerification [userVerificationId=" + userVerificationId + ", userId=" + userId + ", taskType="
				+ taskType + ", remarks=" + remarks + ", activeStatus=" + activeStatus + ", enteredBy=" + enteredBy
