...
@Entity(name="MLFM_ORDER_ITEM_QTY_IMAGE")
public class ModelOrderItemQtyImage {
	
	@Id @GenericGenerator(name = "custom_sequence", strategy = 
			"com.biziitech.mlfm.IdGenerator")
	@GeneratedValue(generator = "custom_sequence")
	@Column(name="ORDER_ITEM_QTY_IMAGE_ID")
	private Long orderItemQtyImageId;
    ...
    public ModelOrderItemQtyImage() {
    	
    }

	public Long getOrderItemQtyImageId() {
		return orderItemQtyImageId;
	}

	public void setOrderItemQtyImageId(Long orderItemQtyImageId) {
		this.orderItemQtyImageId = orderItemQtyImageId;
	}
	...
	public String toString() {
		return "ModelOrderItemQtyImage [orderItemQtyImageId=" + orderItemQtyImageId + ", modelOrderItemQty="
				+ modelOrderItemQty + ", itemImage=" + itemImage + ", imageCaption=" + imageCaption + ", imageDesc="
				+ imageDesc + ", remarks=" + remarks + ", activeStatus=" + activeStatus + ", enteredBy=" + enteredBy
