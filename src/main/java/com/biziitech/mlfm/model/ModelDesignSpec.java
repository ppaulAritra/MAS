...
@Entity(name="MLFM_DESIGN_SPEC")
public class ModelDesignSpec {
	
	@Id @GenericGenerator(name = "custom_sequence", strategy = 
			"com.biziitech.mlfm.IdGenerator")
	@GeneratedValue(generator = "custom_sequence")
	@Column(name="DESIGN_SPEC_ID")
	...
	public String toString() {
		return "ModelDesignSpec [designSpecId=" + designSpecId + ", modelDesign=" + modelDesign + ", modelSpec="
				+ modelSpec + ", specValue=" + specValue + ", modelUOM=" + modelUOM + ", remarks=" + remarks
				+ ", activeStatus=" + activeStatus + ", enteredBy=" + enteredBy + ", entryTimestamp=" + entryTimestamp
				+ ", updatedBy=" + updatedBy + ", updateTimestap=" + updateTimestap + ", flex1=" + flex1 + ", flex2="
