...
@Entity(name="MLFM_COST_CHD")
public class ModelCostChd {
	

	@Id @GenericGenerator(name = "custom_sequence", strategy = 
			"com.biziitech.mlfm.IdGenerator")
	@GeneratedValue(generator = "custom_sequence")
	@Column(name="COST_CHD_ID")
	private Long costChdId;
	
	@Column(name="COST_MSD_ID")
	private long costMsdId;
	...
	public Long getCostChdId() {
		return costChdId;
	}

	public void setCostChdId(Long costChdId) {
		this.costChdId = costChdId;
	}

	public long getCostMsdId() {
		return costMsdId;
	}

	public void setCostMsdId(long costMsdId) {
		this.costMsdId = costMsdId;
	}
	...
	public String toString() {
		return "ModelCostChd [costChdId=" + costChdId + ", costMsdId=" + costMsdId + ", costHeadId=" + costHeadId
				+ ", unitPrice=" + unitPrice + ", remarks=" + remarks + ", activeStatus=" + activeStatus
